...
namespace Multiple_Socket_Client
{
    ...
    class Program
    {
        ...
        private static void SendLoop()
        {
            ...
            byte[] receivedBuf1 = new byte[1024];
            int rec1 = _clientSocket.Receive(receivedBuf1);
            byte[] data1 = new byte[rec1];
            Array.Copy(receivedBuf1, data1, rec1);
            Console.WriteLine("Received: " + Encoding.ASCII.GetString(data1));
